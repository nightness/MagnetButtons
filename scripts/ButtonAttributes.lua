...
addon.allAttributes = {
	"type", "type1", "type2", "type3", "type4", "type5", "tooltip", "texture", "zoneType", "checkselfcast", "checkfocuscast", "isusable-item", "isusable-spell",
	...
	"hotkey", "hoykey1", "hotkey2", "hotkey3", "hotkey4", "hotkey5", "value1", "value2", "value3", "value4", "value5",
